...
_BASE_SYSTEM_PROMPT = (
    ...
    "5a. For ANY calendar / meeting / schedule question, ALWAYS call "
    "list_calendar_events first. Kaisho ships with calendar "
    "integration (CalDAV + Google Calendar). NEVER claim you have no "
    "calendar access without trying the tool. If the tool returns "
    "zero events, report 'calendar is empty in this window' -- not "
