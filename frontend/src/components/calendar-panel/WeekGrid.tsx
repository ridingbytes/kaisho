...
function DayHeader({ days }: { days: Date[] }) {
  ...
  return (
    <div className="flex border-b border-border bg-surface-card">
      <div className="w-12 shrink-0 flex items-end justify-center pb-1 text-[10px] text-fg-muted">
        {wk !== null && (
          <span title={t("week")}>
            {t("weekShort")} {wk}
          </span>
...
function AllDayStrip({
  ...
  return (
    <div className="flex border-b border-border bg-surface-card">
      <div className="w-12 shrink-0 py-1 text-[10px] text-fg-subtle text-right pr-1">
        all-day
      </div>
      <div
    ...
    <div className="w-12 shrink-0 border-r border-border">
      {Array.from({ length: DAY_HOURS }, (_, h) => (
        <div
          ...
          className="text-[10px] text-fg-subtle text-right pr-1 border-b border-border"
        >
