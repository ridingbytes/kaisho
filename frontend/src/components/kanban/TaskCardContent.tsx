      ...
      <div className="flex items-center gap-2 flex-wrap">
        {task.github_url && (
          <a
            ...
            className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-medium bg-surface-overlay border border-border-subtle text-fg hover:text-cta hover:border-cta transition-colors"
            ...
            {task.tags.map((tagName) => {
              ...
              return def ? (
                ...
                <button
                  ...
                  className="px-1.5 py-0.5 rounded text-[10px] font-medium bg-surface-overlay text-fg border border-border-subtle hover:border-cta hover:text-cta transition-colors"
                >
                  {tagName}
                </button>
              );
